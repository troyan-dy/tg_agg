...
📝 Сменить ленту, 🕒 Часы, ❓ Помощь). Кнопки «📝 Сменить ленту» и «🕒 Часы»
запускают диалог — бот ждёт ссылку (или часы) следующим сообщением. Те же
...
| `/sethours 9,13,18` | задать часы публикации (в `TIMEZONE`), расписание применяется сразу |
